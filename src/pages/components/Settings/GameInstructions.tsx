  ...
  return (
    <div className={styles.instructions_container}>
      ...
      <p>
        ...
        you? You just pick the person you think blurted out the quote. Try your best... or maybe
        just close your eyes and guess. Either way, good luck. It appears you’re going to need it.
      </p>
      <p>
